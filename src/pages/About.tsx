  ...
  const team = [
    {
      ...
      bio: "Moussa Kalla est Data Scientist et Ingénieur Machine Learning, spécialisé en modélisation prédictive et IA avancée. Actuellement chez TotalEnergies en France, il conçoit des solutions basées sur l'IA pour la prise de décision et l'analyse de données, alliant expertise en mathématiques, deep learning et data science.",
    ...
    },
    {
      ...
      education: 'Diplôme en Informatique & Télécommunications, ESM/ESG Groupe Sodesi',
